...
export const getCookieDictionary = async (
  locale: Locale,
): Promise<CookieConsentTranslations> => {
  if (locale === 'ar') {
...
export const getBlogDictionary = async (
  locale: Locale,
...
export const getVideoPageMetadataDictionary = async (
  locale: Locale,
): Promise<PageMetadata> => {
  if (locale === 'ar') {
    return (await import('./dictioraries/compression/video/metadata/ar.json'))
      .default;
  }
  if (locale === 'de') {
    return (await import('./dictioraries/compression/video/metadata/de.json'))
      .default;
  }
  if (locale === 'es') {
    return (await import('./dictioraries/compression/video/metadata/es.json'))
      .default;
  }
  if (locale === 'fr') {
    return (await import('./dictioraries/compression/video/metadata/fr.json'))
      .default;
  }
  if (locale === 'it') {
    return (await import('./dictioraries/compression/video/metadata/it.json'))
      .default;
  }
  if (locale === 'zh') {
    return (await import('./dictioraries/compression/video/metadata/zh.json'))
      .default;
  }
  return (await import('./dictioraries/compression/video/metadata/en.json'))
    .default;
};
export const getImagePageMetadataDictionary = async (
  locale: Locale,
): Promise<PageMetadata> => {
  if (locale === 'ar') {
    return (await import('./dictioraries/compression/image/metadata/ar.json'))
      .default;
  }
  if (locale === 'de') {
    return (await import('./dictioraries/compression/image/metadata/de.json'))
      .default;
  }
  if (locale === 'es') {
    return (await import('./dictioraries/compression/image/metadata/es.json'))
      .default;
  }
  if (locale === 'fr') {
    return (await import('./dictioraries/compression/image/metadata/fr.json'))
      .default;
  }
  if (locale === 'it') {
    return (await import('./dictioraries/compression/image/metadata/it.json'))
      .default;
  }
  if (locale === 'zh') {
    return (await import('./dictioraries/compression/image/metadata/zh.json'))
      .default;
  }
  return (await import('./dictioraries/compression/image/metadata/en.json'))
    .default;
};
export const getImagePageSeoDictionary = async (
  locale: Locale,
): Promise<CompressionPageSeoTranslations> => {
  if (locale === 'ar') {
    return (await import('./dictioraries/compression/image/seo/ar.json'))
      .default;
  }
  if (locale === 'de') {
    return (await import('./dictioraries/compression/image/seo/de.json'))
      .default;
  }
  if (locale === 'es') {
    return (await import('./dictioraries/compression/image/seo/es.json'))
      .default;
  }
  if (locale === 'fr') {
    return (await import('./dictioraries/compression/image/seo/fr.json'))
      .default;
  }
  if (locale === 'it') {
    return (await import('./dictioraries/compression/image/seo/it.json'))
      .default;
  }
  if (locale === 'zh') {
    return (await import('./dictioraries/compression/image/seo/zh.json'))
      .default;
  }
  return (await import('./dictioraries/compression/image/seo/en.json')).default;
};
export const getVideoPageSeoDictionary = async (
  locale: Locale,
): Promise<CompressionPageSeoTranslations> => {
  if (locale === 'ar') {
    return (await import('./dictioraries/compression/video/seo/ar.json'))
      .default;
  }
  if (locale === 'de') {
    return (await import('./dictioraries/compression/video/seo/de.json'))
      .default;
  }
  if (locale === 'es') {
    return (await import('./dictioraries/compression/video/seo/es.json'))
      .default;
  }
  if (locale === 'fr') {
    return (await import('./dictioraries/compression/video/seo/fr.json'))
      .default;
  }
  if (locale === 'it') {
    return (await import('./dictioraries/compression/video/seo/it.json'))
      .default;
  }
  if (locale === 'zh') {
    return (await import('./dictioraries/compression/video/seo/zh.json'))
      .default;
  }
  return (await import('./dictioraries/compression/video/seo/en.json')).default;
};
export const getRedirectionDictionary = async (
  locale: Locale,
): Promise<RedirectingTranslations> => {
  if (locale === 'ar') {
...
export const getNavBarDictionary = async (
  locale: Locale,
): Promise<NavBarTranslations> => {
  if (locale === 'ar') {
...
export const getFooterDictionary = async (
  locale: Locale,
