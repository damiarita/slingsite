...
export default async function App({params}:Props) {
  ...
  return <div dangerouslySetInnerHTML={{__html:`
      ...
      <div id="sib-form-container" class="sib-form-container">
        <div id="error-message" class="sib-form-message-panel" style="font-size:16px; text-align:left; font-family:Helvetica, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;max-width:540px;">
          <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
            ...
            <span class="sib-form-message-panel__inner-text">
                              We have not been able to confirm the suscription
                          </span>
          </div>
        </div>
        <div></div>
        <div id="success-message" class="sib-form-message-panel" style="font-size:16px; text-align:left; font-family:Helvetica, sans-serif; color:#085229; background-color:#e7faf0; border-radius:3px; border-color:#13ce66;max-width:540px;">
          <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
            ...
            <span class="sib-form-message-panel__inner-text">
                              Correctly Suscribed to the Newsletter. Thanks!
                          </span>
          </div>
        </div>
        <div></div>
        <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr">
          <form id="sib-form" method="POST" action="https://5004d848.sibforms.com/serve/MUIFAOBz8aFyqXQsKafpp1E5EXI2nNwYmPDY8NpOkaBf7qiTzQfXrtQvVJVHxJQ4zg2RIJFkd490i7rSJUNJGhSQDbf-40ybOHmk1rzknE8svW_g00PUyh9obSNUXvknFtWMf7ZiVPUqYvVyAKtX-tmy8EzhzGVQrXTPrnsLyAwUfbZaOBXyNFI3grVAp4mrHuW1mvw03QbgqbK2" data-type="subscription">
              ...
              <div class="sib-input sib-form-block">
                <div class="form__entry entry_block">
                  <div class="form__label-row ">
                    ...
                    <div class="entry__field">
                      <input class="input " maxlength="200" type="text" id="NOMBRE" name="NOMBRE" autocomplete="off" placeholder="NAME" />
                    </div>
                  </div>
                ...
                <div class="form__entry entry_block">
                  <div class="form__label-row ">
                    ...
                    <div class="sib-sms-input-wrapper" style="direction:ltr">
                      <div class="sib-sms-input" data-placeholder="SMS" data-required="" data-country-code="ES" data-whatsapp-country-code="ES" data-value="" data-whatsappvalue="" data-attributename="SMS">
                        <div class="entry__field">
            ...
            <div style="padding: 8px 0;">
              <div class="g-recaptcha-v3" data-sitekey="6Lc9k8grAAAAAHxsqdAJnDsemfzLJPF6Y2pIXb_U" style="display: none"></div>
            </div>
            <div style="padding: 8px 0;">
    ...
    <script>
      ...
      window.LOCALE = 'es';
      window.EMAIL_INVALID_MESSAGE = window.SMS_INVALID_MESSAGE = "The provided information is not valid. Please, check this value and try again.";

      window.REQUIRED_ERROR_MESSAGE = "This field cannot be empty ";

      window.GENERIC_INVALID_MESSAGE = "The provided information is not valid. Please, check this value and try again.";
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6Lc9k8grAAAAAHxsqdAJnDsemfzLJPF6Y2pIXb_U&hl=es" async defer></script>
